...
class BoilTank(Thread):
    ...
    def __init__(self, start_heat_queue, start_boil_queue, need_cleaning_queue, period=1, testing_queue_input=None):
        self.period = period
        ...
        self.boiltank_programmed_queue = Queue.Queue()
        self.boil_steps = []
        self.start_time = 0
        self.stop_time = 0
        self.period = period
    ...
    def boiltank_programmed(self):
        self.boiltank_programmed_queue.put(None)
    ...
    def run(self):
        ...
        while 1:
            ...
            self.boiltank_programmed_queue.get() # boiltank has recipe
